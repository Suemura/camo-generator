...
export const PRESETS = {
  ...
  mm14: {
    ...
    layers: [
      {color: 3, ratio: 0.56, eat: [0], min: 0.012, max: 0.050, compact: 1.5, drift: 1.4, jitter: 1.0, wander: 0.30, stratify: 5},
      {color: 2, ratio: 0.42, eat: [3], min: 0.008, max: 0.035, compact: 1.5, drift: 1.4, jitter: 1.0, wander: 0.30},
      {color: 1, ratio: 0.22, eat: [2], min: 0.004, max: 0.018, compact: 1.7, drift: 1.3, jitter: 1.0, wander: 0.30},
    ...
    // 色は製造元仕様の Pantone TCX 5 色の sRGB 換算値 (Pantone 公式は非公開のため、encycolorpedia / colorshunter / colorxs で
    // 一致する第三者換算値)。布地写真からの実測 (k=5 --core=2: #a9a988 / #929574 / #7b8266 / #676c4f / #53583f) は
    // 写真の緑被りで全色が緑側へ寄り、明暗差も圧縮されるため採らない。camopedia の 2 枚は暖色 / 寒色に被りが逆で、
    // 写真間の差が仕様との差より大きい
    colors: [
      {name:'グレーグリーン',   hex:'#75663e'},
      {name:'ライトベージュ',   hex:'#bfaf92'},
      {name:'ライトグリーン',   hex:'#938b78'},
      {name:'スワンプグリーン', hex:'#817a60'},
      {name:'ダークグレー',     hex:'#434237'},
    ],
  },
  dcu: {
