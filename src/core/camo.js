...
export const PRESETS = {
  ...
  dpm: {
    ...
    //     黒を最後に刷るため、パッチ輪郭で筆跡が途切れないよう最上層の版 (topLayer) にする
    //     (woodland / cce と同じ v21/v22 の構造)
    ...
    // 実測: node tools/extract-palette.mjs refs/dpm.jpg 6 --core --flatten=250
    // (照明ムラで砂色が明部 / 暗部の 2 クラスタに割れ、k=4 では黒とブラウンが分離しない。
    //  k=6 で測り、砂色は明部側、他 3 色はそれぞれの単一クラスタを採る)
    colors: [
      {name:'サンド',     hex:'#d8a858'},
