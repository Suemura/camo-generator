...
export const PRESETS = {
  ...
  mm14: {
    ...
    //       各層が親の版だけを食うので、鎖の隣接関係が構造として保たれる
    //   - ダークグレーは地の上だけに出る小塊と、対角方向に階段状に連なる「虫状」の鎖 → eat: [0]、drift を高く compact を低く
    ...
    //   - 実物の縁は MARPAT ほど細かく噛み合わず、単セルの孤立点がまばらに散る程度 → スペックルは弱め、ディザは 1 回
    name: 'MM-14 (ウクライナ)', kind: 'growth', ref: 'mm14',
    cell: 10, growDither: 1,
    layers: [
      {color: 3, ratio: 0.56, eat: [0], min: 0.010, max: 0.035, compact: 1.5, drift: 1.4, jitter: 1.0, wander: 0.30, stratify: 6},
      {color: 2, ratio: 0.42, eat: [3], min: 0.005, max: 0.020, compact: 1.5, drift: 1.4, jitter: 1.0, wander: 0.30},
      {color: 1, ratio: 0.22, eat: [2], min: 0.003, max: 0.012, compact: 1.7, drift: 1.3, jitter: 1.0, wander: 0.30},
      {color: 4, ratio: 0.12, eat: [0], min: 0.0008, max: 0.004, compact: 0.6, drift: 3.2, jitter: 0.8, wander: 0.25},
    ],
    growSpeckle: [
