...
//   量子化とパレットの前提を揃える。
// --blur=SIGMA: 縮小後にガウシアンぼかしをかける (tools/gen-src.mjs の --blur と同じ前処理)。
//   リップストップ等の織り目が明るい格子として写っている布地写真では、その筋が最明色クラスタを
//   丸ごと占有して迷彩の色が 1 色ぶん失われる。織り目の周期より大きい sigma で潰すと本来の色が出る。
